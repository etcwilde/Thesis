...
BitKeeper is a distributed version control system (DVCS). In distributed
...
copy of the repository with the public upstream repository less often
than with centralized version control.
The public upstream repository can be thought of as being the equivalent
of the central repository in a
centralized system.
...
the results back into the upstream master repository.
...
It is also desirable to have the commits in the upstream repository be
