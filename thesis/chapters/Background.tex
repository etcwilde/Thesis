...
\begin{figure}[htbp]
  ...
  \caption{A small example of a sequence of commits and merges.
    The branch pointer A references commit 7, which merges the head of
...
% TODO: Try to figure out how many foxtrots there are? -- maybe
...
\begin{figure}[htbp]
  \begin{tabulary}{\textwidth}{LLL}
    ...
    % TODO: Fix alice_2 - should have origin/master on commit 1 until she pushes
...
This structure is reflected in the repository graph.
...
% TODO: comment on the dip in 3.16 - probably linked to the fact that 79 merges were integrated in one merge that would otherwise have been separate
