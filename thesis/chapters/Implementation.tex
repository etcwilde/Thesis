...
pre-compute the vectors for each commit. % TODO 19: example, or why?
...
% TODO 20: Do this asynchronously - it is, but the results are not cached, so it must still be gathered from the database
...
% TODO 21: provide a link to Linvis
