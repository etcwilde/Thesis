...
% TODO 22: How often did this happen? - not sure
...
% TODO 23: Why not more complex trees? - People had to be able to work with them in Gitk
...
% TODO 24: What tools were available to participants with the conceptual tasks
...
% TODO 25: Provide an illustration of the direction of the edges
...
the case of the medium-sized merge, that there is a medium effect.
So why does the Wilcoxon test indicate that the null hypothesis should
not be rejected?  % TODO 26: Does Effect size make sense if not statistically significant
