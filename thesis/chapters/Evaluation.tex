...
\evan{I'm not really sure how to say this\ldots. It might not even be
  necessary? What do you think of just removing the first question?
  It would remove the first part of the study though.}
...
question, ``Are people able to draw a conceptual understanding from the
visualization of the DAG in Gitk''.
...
\begin{itemize}
  ...
  \item \tool{} doe snot have an impact on the time taken to respond
\end{itemize}
