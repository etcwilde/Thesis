...
% TODO: What are the properties and how likely?
...
Commits have a single path to reach the master branch, which makes % TODO: What about foxtrots?
...
the model enables easy aggregation of commit metadata at merges, % TODO: Comment 10 in what sense?
...
It is desirable to reconstruct all of the branch and repository % TODO: 11: provide example of when (foxtrots) - git loses information about which branch a commit is coming from and relies entirely on the commit parents
...
merged twice. In the case of node 9, it is merged into 11, though it % TODO 12: Why a second time?
...
is presented in Algorithm~\ref{fig:alg}. % TODO 13: Does this heuristic apply to other repos?
...
reference to the commit that has no parents. % TODO 14: More than one root?
...
merges made by Linus Torvalds into the master branch. % TODO 15: Inner product or intersection?
...
% TODO 16: difference between this case and the earlier commits?
...
\begin{figure}[htpb]
  ...
  \label{fig:big_tree}
  % TODO 18: How to interpret this visualization when the packtree is introduced later
\end{figure}
