...
the median group size contains seven items.
...
a commit is integrated, and what other commits are integrated with it.
...
The first phase determines which repository events happened on the mater
branch.
